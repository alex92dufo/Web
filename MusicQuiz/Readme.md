The goal of this exercice was mainly to use the library Bootstrap in the developpement of a web application where the user plays an interactive quiz on music bases.
